...
from lecturebot.tools import (
    ...
    answer_transcript_summary_node,
...
def route_after_question_analysis(state: ChatPipelineState) -> str:
    if state.get("answer_mode") == "whole_transcript_summary":
        return "summary"
    return "rag"
...
workflow.add_node("answer_transcript_summary", answer_transcript_summary_node)
...
workflow.add_conditional_edges(
    ...
    {
        "summary": "answer_transcript_summary",
...
workflow.add_edge("answer_transcript_summary", "summarize_memory")
